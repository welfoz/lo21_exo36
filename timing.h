...
namespace TIME {
    /*! \class TimeException
            \brief Classe permettant de gÈrer les exceptions des classes du namespace TIME
    */
    class TimeException{
    public:
    ...
    /*! \class Date
            ...
            L'utilisation de cette classe nÈcessite des dates valides au sens commun du terme.
            DÈclenchement d'exception dans le cas contraire
    */
    class Date {
    public:
    ...
    */
    ...
    /*! \class Periode
            \brief Classe permettant de manipuler des periodes exprimÈes en jours/mois/annÈes
            L'utilisation de cette classe nÈcessite des dates valides au sens commun du terme.
            DÈclenchement d'exception dans le cas contraire
    */
    class Periode{
    public :
        //! Constructeur ‡ partir de jour/mois/annÈe
        /*! \param j nombre de jours avec 0<=j<=364
            \param m nombre de mois avec 0<=m<=11
            \param a nombre d'annÈes
            */
    ...
    */
    ...
    public:
        ...
        /*! \param d date de dÈbut de l'intervalle
        ...
        Date getDebut() const { return debut; } //<! Retourne la date de dÈbut de l'intervalle
        Date getFin() const { return fin; } //<! Retourne la date de fin de l'intervalle
        int getDuree() const { return fin-debut; } //<! Retourne le nombre de jours s'Ècoulant entre le dÈbut et la fin de l'intervalle
